...
## ⚠️ Important: ACPI Shutdown Issue (GUI VMs)
**❌ Problem**
...
**Inside the guest OS:**
**1️⃣ Switch default target to CLI**
```bash
    sudo systemctl set-default multi-user.target
```

**2️⃣ (Optional but recommended) Disable display manager**
```bash
